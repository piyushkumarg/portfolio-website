    ...
    <>
      <footer className="bg-bgDark text-content flex justify-center items-center gap-6 pb-4 text-lg w-full relative select-none bg-cover flex-col">
        ...
        <div className="absolute top-4 flex flex-col justify-center items-center gap-5 font-carattere tracking-[0.2em] ">
          ...
          <Link
            to="/contact"
            className=" flex gap-2 items-center   border-2 w-fit border-buttonMain justify-center transition ease-in-out delay-150 hover:-translate-y hover:scale-110 duration-500 text-lg text-contentHighlight font-semibold p-2 rounded-lg  tracking-widest"
          >
      ...
      <div className="sticky bottom-0 border-none bg-bgDark text-white  flex justify-end items-center p-1 md:pr-4 z-50 ">
        ...
        <div className="font-carattere font-semibold tracking-[0.2em] flex items-center gap-2  w-full justify-center text-content">
          &copy; {currentYear} Designed & Code by{" "}
          <div className="flex gap-1 items-center sm:text-xl  font-bold font-carattere ">
