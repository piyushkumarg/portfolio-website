    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 w-full text-content text-lg font-medium">
      ...
      <a href="https://deepcore.in" target="_blank">
        <motion.div
          ...
          initial="initial"
          whileInView="animate"
          className="cursor-pointer bg-gradient-to-r from-blue-900/30 to-purple-900/30 rounded-xl p-8 mb-12 border-2 overflow-hidden border-blue-900/30 hover:bg-gradient-to-r hover:from-blue-900/50 hover:to-purple-900/50 hover:border-blue-900/50"
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-content/10 rounded-lg p-4">
